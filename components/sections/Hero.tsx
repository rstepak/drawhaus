      ...
      <div className="relative z-10 flex flex-1 flex-col lg:flex-row lg:items-center">
        ...
        <div className="flex flex-1 flex-col justify-center px-6 md:px-12 lg:px-16 xl:px-20 pb-16 md:pb-24 pt-8">
          <div className="max-w-2xl">
            ...
            {/* Mobile image — between headline and body copy */}
            <div className="relative lg:hidden w-full h-56 sm:h-64 mb-8 overflow-hidden">
              <Image
              ...
              />
              <div aria-hidden="true" className="absolute inset-0" style={{ background: 'rgba(12,11,10,0.25)' }} />
            </div>
